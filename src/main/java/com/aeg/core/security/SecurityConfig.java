	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
			...
			.authorizeHttpRequests(authorize -> {
				...
				.requestMatchers(HttpMethod.GET, "/api/printers/**").hasAnyRole("ADMIN", "DISTRIBUTOR", "TECHNICIAN")
				...
				.requestMatchers("/api/seals/**", "/api/technical-services/**").hasAnyRole("ADMIN", "TECHNICIAN", "SERVICE_CENTER")
				.requestMatchers("/api/annual-inspections/**").hasAnyRole("ADMIN", "DISTRIBUTOR", "TECHNICIAN", "SERVICE_CENTER")
